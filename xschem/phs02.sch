...
.endc
"}
C {lab_wire.sym} 1180 -710 0 0 {name=p2 sig_type=std_logic lab=b0
}
C {lab_wire.sym} 1360 -710 0 0 {name=p3 sig_type=std_logic lab=b1

}
C {lab_wire.sym} 1530 -710 0 0 {name=p4 sig_type=std_logic lab=b2

}
C {lab_wire.sym} 1700 -710 0 0 {name=p5 sig_type=std_logic lab=b3
}
C {lab_wire.sym} 1870 -710 0 0 {name=p6 sig_type=std_logic lab=b4
}
...
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/phs02.raw ac"
}
...
C {gnd.sym} 1210 -670 1 0 {name=l10 lab=GND}
...
C {vcvs.sym} 1250 -690 0 0 {name=E1 value=3}
C {vcvs.sym} 1430 -690 0 0 {name=E2 value=3}
C {vcvs.sym} 1600 -690 0 0 {name=E3 value=3}
C {vcvs.sym} 1770 -690 0 0 {name=E4 value=3}
C {vcvs.sym} 1940 -690 0 0 {name=E5 value=3}
